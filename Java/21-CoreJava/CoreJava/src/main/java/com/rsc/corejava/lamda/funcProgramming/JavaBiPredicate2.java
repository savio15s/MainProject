...
public class JavaBiPredicate2 {
    public static void main(String[] args) {
        ...
        System.out.println("=" + result); // google.com, rsc.com

        //  if score == 0
        List<Domain> result2 = filterBadDomain(domains, (domain, score) -> score == 0);
        System.out.println("==" + result2); // rsc.com, microsoft.com
    ...
    public static  List<Domain> filterBadDomain(
            List<Domain> list, BiPredicate<String, Integer> biPredicate) {
